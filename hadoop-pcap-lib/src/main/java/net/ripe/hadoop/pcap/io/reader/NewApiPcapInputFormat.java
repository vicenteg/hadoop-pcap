...
public class NewApiPcapInputFormat extends org.apache.hadoop.mapreduce.lib.input.FileInputFormat<LongWritable, ObjectWritable> {
    static final String READER_CLASS_PROPERTY = "net.ripe.hadoop.pcap.io.reader.class";

    public static final Log LOG = LogFactory.getLog(NewApiPcapInputFormat.class);
    ...
    public static NewApiPcapRecordReader initPcapRecordReader(Path path, long start, long length, TaskAttemptContext context) throws IOException {
        ...
        return new NewApiPcapRecordReader(reader, start, length, baseStream, stream);
    }
