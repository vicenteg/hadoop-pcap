...
public class NewApiPcapRecordReader extends RecordReader<LongWritable, ObjectWritable> {
    ...
    public NewApiPcapRecordReader(PcapReader pcapReader, long start, long end, Seekable baseStream, DataInputStream stream) throws IOException {
